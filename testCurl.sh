...
curl -X POST $CATEGORIAS_URL -H "Content-Type: application/json" -d '{"nombre": "Bodas"}'
echo -e "\n"
print_separator
...
-d '{"nombre": "Romana", "precio": 50000.00, "categoria": {"id": 1}}'  # Referencia a la categoría creada (ID 1)
echo -e "\n"
# curl -X POST $PRODUCTOS_URL -H "Content-Type: application/json" \  # Opcional si se creó la segunda categoría
# -d '{"nombre": "Italiana", "precio": 34500.99, "categoria": {"id": 2}}'  # Referencia a la segunda categoría (ID 2)
echo -e "\n"
print_separator
...
# -d '{"nombre": "Romana actualizado", "precio": 494444.99, "categoria": {"id": 1}}'
# echo -e "\n"
# print_separator
